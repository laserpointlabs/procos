...
const ContextEntityNode: React.FC<NodeProps<OntologyNodeData>> = ({ data, selected }) => {
    ...
    const iconContainerStyle = {
        ...
        background: `linear-gradient(135deg, ${dadmsTheme.colors.accent.primary}, ${dadmsTheme.colors.accent.primary}dd)`,
    ...
    return (
        <div style={{
            background: isExternal ? dadmsTheme.colors.background.tertiary : dadmsTheme.colors.accent.primary,
            border: `2px ${isExternal ? 'dashed' : 'solid'} ${selected ? dadmsTheme.colors.border.focus : (isExternal ? dadmsTheme.colors.border.light : dadmsTheme.colors.accent.primary)}`,
            ...
            <Handle type="target" position={Position.Top} style={{ background: dadmsTheme.colors.accent.primary, border: `2px solid ${dadmsTheme.colors.background.primary}` }} />

            <div style={headerStyle}>
                <div style={iconContainerStyle}>
                    <Icon name="settings-gear" size="xs" />
                </div>
            ...
            <Handle type="source" position={Position.Bottom} style={{ background: dadmsTheme.colors.accent.primary, border: `2px solid ${dadmsTheme.colors.background.primary}` }} />
        </div>
    );
};

export default ContextEntityNode; 