...
const ProcessEntityNode: React.FC<NodeProps<OntologyNodeData>> = ({ data, selected }) => {
    ...
    const iconContainerStyle = {
        ...
        background: `linear-gradient(135deg, ${dadmsTheme.colors.accent.warning}, ${dadmsTheme.colors.accent.warning}dd)`,
    ...
    return (
        <div style={{
            background: isExternal ? dadmsTheme.colors.background.tertiary : dadmsTheme.colors.accent.warning,
            border: `2px ${isExternal ? 'dashed' : 'solid'} ${selected ? dadmsTheme.colors.border.focus : (isExternal ? dadmsTheme.colors.border.light : dadmsTheme.colors.accent.warning)}`,
            ...
            <Handle type="target" position={Position.Top} style={{ background: dadmsTheme.colors.accent.warning, border: `2px solid ${dadmsTheme.colors.background.primary}` }} />
            ...
            <Handle type="source" position={Position.Bottom} style={{ background: dadmsTheme.colors.accent.warning, border: `2px solid ${dadmsTheme.colors.background.primary}` }} />
        </div>
    );
};

export default ProcessEntityNode; 